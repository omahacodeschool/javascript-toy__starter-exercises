...
var password = "OpenSaysAMe";

var users_password = prompt("Say the magic words!","The magic words are...");
if (users_password = password){
  alert("You may now enter");
} else {
  alert("Incorrect. The password is " + password + ".");
}
