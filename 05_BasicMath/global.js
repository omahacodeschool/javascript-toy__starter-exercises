...
var differenc = (first_num - second_num - third_num);
var product = (first_num * second_num * third_num);
var quotient = (first_num / second_num);
var increase = (first_num++);
var decrease = (second_num--);

// Educate user
alert( "The sum of " + first_num "," + second_num + ", and" + third_num + "is " sum +".");
...
alert("The quotient of " + first_num + " divided by" + second_num +
 "is " + quotient + ".");
alert(first_num + " increased by 1 is " + increase + ".");
alert(first_num + " decreased by 1 is " + decrease + ".");
